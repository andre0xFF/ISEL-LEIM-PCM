...
class FotoPrint
{
  ...
  init() {
    let r = new Rect(50, 100, 20, 20, "red");
    this.shpinDrawing.insert(r);

    let o = new Oval(150, 100, 50, 1, 1, "blue");
    this.shpinDrawing.insert(o);

    let h = new Heart(250, 100, 40, 20, "pink");
    this.shpinDrawing.insert(h);

    let dad = new Picture(300, 100, 70, 70, "imgs/allison1.jpg");
  ...
  cloneObj(obj) {
    ...
    switch (obj.name) {
      ...
      case "H":
        item = new Heart(obj.posx + 20, obj.posy + 20, obj.h, obj.drx, obj.color);
        break;
      default:
